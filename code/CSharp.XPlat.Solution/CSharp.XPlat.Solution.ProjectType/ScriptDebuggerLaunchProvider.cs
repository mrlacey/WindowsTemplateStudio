...
namespace CSharpXPlatSolution
{
    ...
    public class ScriptDebuggerLaunchProvider : DebugLaunchProviderBase
    {
        ...
        [ExportPropertyXamlRuleDefinition("CSharpXPlatSolution, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9be6e469bc4921f1", "XamlRuleToCode:ScriptDebugger.xaml", "Project")]
        [AppliesTo(MyUnconfiguredProject.UniqueCapability)]
