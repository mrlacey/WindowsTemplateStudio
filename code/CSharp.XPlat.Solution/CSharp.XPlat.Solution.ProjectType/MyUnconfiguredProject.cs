...
namespace CSharpXPlatSolution
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "CSharp.XPlat.Solution", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </remarks>
        internal const string UniqueCapability = "CSharp.XPlat.Solution";
